...
export const establishments = [
  {
    ...
    recommendations: ['Recomendar um blend', 'Harmonização de doces', 'Horário de funcionamento'],
  ...
  },
  {
    ...
    recommendations: ['Planos de treino', 'Horários de aula', 'Avaliação física'],
  ...
  },
  {
    ...
    recommendations: ['Agendar consulta', 'Especialidades', 'Convênios aceitos'],
